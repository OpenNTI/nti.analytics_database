...
class ForumMixin(RootContextMixin):
    ...
    @declared_attr
    def forum_id(self):
        return Column('forum_id', Integer, ForeignKey("ForumsCreated.forum_id"),
...
class TopicMixin(ForumMixin):
    ...
    @declared_attr
    def topic_id(self):
        return Column('topic_id', Integer, ForeignKey("TopicsCreated.topic_id"), 
					  nullable=False, index=True)
...
class ForumsCreated(Base, BaseTableMixin, RootContextMixin, DeletedMixin):
    ...
    forum_ds_id = Column('forum_ds_id', INTID_COLUMN_TYPE,
                         nullable=True, index=True, autoincrement=False)
    
    forum_id = Column('forum_id', Integer, Sequence('forum_seq'), 
...
class TopicsCreated(Base, BaseTableMixin, ForumMixin, DeletedMixin, RatingsMixin):
    ...
    topic_ds_id = Column('topic_ds_id', INTID_COLUMN_TYPE,
                         nullable=True, autoincrement=False, index=True)
    
    topic_id = Column('topic_id', Integer, Sequence('topic_seq'), 
					  index=True, nullable=False, primary_key=True)
